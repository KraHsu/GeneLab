...
- **R7 (ADR-0009)** — flipping importlinter from lint-only to blocking is gated on the R0.3 baseline being clean. Post-R1: **21 cross-layer imports remain across 2 broken contracts** (down from 24 / 3).
