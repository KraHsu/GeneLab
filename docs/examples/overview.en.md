...
| [Franka Pick-and-Place](franka-pick-and-place.md) | `examples/franka_pick_and_place` | Goal-conditioned manipulation, Cartesian EE-delta IK, binary gripper control. |
